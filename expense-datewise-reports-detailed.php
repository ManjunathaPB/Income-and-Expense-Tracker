  ...
  <body>
    <section>
      ...
      <div class="side-bar">
				...
				<div class="menu">
					<div class="item"><a href="sidebar2.php" ></i>Dashboard</a></div>
					...
					<div class="item"><a class="sub-btn"><i class="fas fa-bars"></i>Expense report<i class="fas fa-angle-right dropdown"></i></a>
						<div class="sub-menu">
							<a href="expense-datewise-reports1.php" style="background-color: white;color:black; border:1px solid black;" class="sub-items">Daywise Expenses</a>
    ...
    <div class="section1">
      ...
      <h1 class="header">Datewise Expense Report <button class="Btn" id="download"> download report</button></h1>
      <div class="main1">
        <div class="main">
          <?php
          ...
          <div class="tab" id="invoice">
            <h5 class="headline1">Datewise Expense Report from <?php echo $fdate ?> to <?php echo $tdate ?></h5>
            <table class="table-1">
              <thead>
                <tr>
                <tr>
              ...
              $ret = mysqli_query($conn, "SELECT ExpenseDate,ExpenseItem,SUM(ExpenseCost) as totaldaily FROM `tblexpense`  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by ExpenseDate");
              $cnt = 1;
