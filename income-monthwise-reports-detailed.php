...
?>
    ...
    <body>
        ...
        <div class="section1">
            <h1 class="header">Monthwise Income Report<button class="Btn" id="download"> download report</button></h1>
            <div class="main1">
                <div class="main">
                    ...
                    <div class="tab" id="invoice">
                        <h5 class="headline1">Monthwise Income Report from <?php echo $fdate ?> to <?php echo $tdate ?></h5>
                        <table class="table-1">
                            <thead>
                                <tr>
                                <tr>
                            ...
                            $ret = mysqli_query($conn, "SELECT month(IncomeDate) as rptmonth,year(IncomeDate) as rptyear,IncomeName,SUM(IncomeAmt) as totalmonth FROM tblincome  where (IncomeDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by month(IncomeDate),year(IncomeDate)");
                            $cnt = 1;
