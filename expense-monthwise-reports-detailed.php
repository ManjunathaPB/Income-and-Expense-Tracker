...
?>
    ...
    <body>
				...
				<div class="menu">
					...
					<div class="item"><a class="sub-btn"><i class="fas fa-bars"></i>Expense report<i class="fas fa-angle-right dropdown"></i></a>
						<div class="sub-menu">
							...
							<a href="expense-monthwise-reports1.php" style="background-color: white;color:black; border:1px solid black;" class="sub-items">Monthwise Expenses</a>
        ...
        <div class="section1">
            <h1 class="header">Monthwise Expense Report<button class="Btn" id="download"> download report</button></h1>
            <div class="main1">
                <div class="main">
                    ...
                    <div class="tab" id="invoice">
                        <h5 class="headline1">Monthwise Expense Report from <?php echo $fdate ?> to <?php echo $tdate ?></h5>
                        <table class="table-1">
                            <thead>
                                <tr>
                                <tr>
                            ...
                            $ret = mysqli_query($conn, "SELECT month(ExpenseDate) as rptmonth,year(ExpenseDate) as rptyear,ExpenseItem,SUM(ExpenseCost) as totalmonth FROM tblexpense  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by month(ExpenseDate),year(ExpenseDate)");
                            $cnt = 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="font-size: 25px;color:red">₹ <!--<?php echo $totalsexp; ?>-->
                                        <?php if ($totalsexp == "") {
                                            echo "0";
                                        } else {
                                            echo $totalsexp;
