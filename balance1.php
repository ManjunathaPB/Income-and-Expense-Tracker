...
?>
	...
	<body>
		<section>
			...
			<div class="side-bar">
				...
				<div class="menu">
					...
					<div class="item"><a href="balance1.php" style="background-color: white;color:black; border:1px solid black;"><i class="fas fa-bars"></i>Balance</a></div>
		...
		<!-- <div class="header">Balance Report</div> -->
        <!-- <div class="item"><a href="sidebar2.php"><i class="fas fa-angle-left dropdown"></i>Dashboard</a></div> -->
        <div class="section1">
            <div class="main">
                 <?php
               ...
               // $tdate = $_POST['todate'];
                ?>
                <!-- <h5 class="headline">Yearwise Expense Report from <?php echo $fdate ?> to <?php echo $tdate ?></h5> -->
                <table class="table-1">
                    <thead>
                        <tr>
                        <tr>
                    ...
                    $ret = mysqli_query($conn, "SELECT SUM(ExpenseCost) as totalyear FROM tblexpense  where (UserId='$userid')");
                    $rin = mysqli_query($conn, "SELECT SUM(IncomeAmt) as totalinc FROM tblincome  where (UserId='$userid')");
                    $cnt = 1;
                    while (($row = mysqli_fetch_array($ret)) && ($ric = mysqli_fetch_array($rin))) {

                    ?>

                        <tr>
                            <!-- <td><?php echo $cnt; ?>.</td> -->
                            <td><?php echo $ttin = $ric['totalinc']; ?></td>
                    ...
                    <tr>
                        <th colspan="1" style="text-decoration: none;">Balance</th>
                        <td>
                            <p style="font-size: 25px;color:red">₹ <?php if ($ttbal == "") {
																							       echo "0";
																								} else {
																								   echo $ttbal;
																								}?></p>
