...
if (strlen($_SESSION['user'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($conn, "insert into tblincome(UserId,IncomeDate,IncomeName,IncomeAmt) value('$userid','$dateexpense','$item','$costitem')");
		if ($query) {
			...
			document.addEventListener('DOMContentLoaded', function() {
				...
				// 		window.location.href = 'manage-income1.php';
				// 	}
				// });
			});
		 </script>";
	...
	<body>
			...
			<div class="side-bar">
				...
				<div class="menu">
					...
					<div class="item"><a class="sub-btn"><i class="fas fa-bars"></i>Income<i class="fas fa-angle-right dropdown"></i></a>
						<div class="sub-menu">
							<div class="sub-items"><a href="addincome1.php" style="background-color: white;color:black; border:1px solid black;">Add Income</a></div>
		...
		<div class="section">
			<form role="form" method="post" action="">
				...
				<div class="header">Add Income</div>
