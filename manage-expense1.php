                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div style="background-color: red;" class="delete"><a href="manage-expense1.php?delid=<?php echo $row['ID']; ?>" style="text-decoration:none;color:white"><i class="fas fa-trash"></i>DELETE</a></div>
                                </td>
                                <td>
                                    <div style="background-color: blue;" class="delete"><a href="edit-expense.php?id=<?php echo $row['ID']; ?> " style="text-decoration:none;color:white"><i class="fas fa-edit"></i>EDIT</a></div>
                                </td>
                            </tr>
                        <?php
                        $cnt = $cnt + 1;
