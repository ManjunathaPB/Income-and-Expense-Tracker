...
?>
    ...
    <body>
				...
				<div class="menu">
					...
					<div class="item"><a class="sub-btn"><i class="fas fa-bars"></i>Expense report<i class="fas fa-angle-right dropdown"></i></a>
						<div class="sub-menu">
							...
							<a href="expense-yearwise-reports1.php" style="background-color: white;color:black; border:1px solid black;" class="sub-items">Yearwise Expenses</a>
						</div>
					</div>
        ...
        <div class="section1">
            <h1 class="header">Yearwise Expense Report<button class="Btn" id="download"> download report</button></h1>
            <div class="main1">
                <div class="main">
                    <?php
                    ...
                    <div class="tab" id="invoice">
                        ...
                        <h5 class="headline1">Yearwise Expense Report from <?php echo $fdate ?> to <?php echo $tdate ?></h5>
                        <table class="table-1">
                            <thead>
                                <tr>
                                <tr>
                            ...
                            $ret = mysqli_query($conn, "SELECT year(ExpenseDate) as rptyear,ExpenseItem,SUM(ExpenseCost) as totalyear FROM tblexpense  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by year(ExpenseDate)");
                            $cnt = 1;
