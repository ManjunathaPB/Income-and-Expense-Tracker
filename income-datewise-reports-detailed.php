...
?>
  ...
  <body>
      ...
      <div class="side-bar">
				...
				<div class="menu">
					...
					<div class="item"><a class="sub-btn"><i class="fas fa-bars"></i>Income report<i class="fas fa-angle-right dropdown"></i></a>
						<div class="sub-menu">
							<a href="income-date-report.php" style="background-color: white;color:black; border:1px solid black;" class="sub-items">Daywise Income</a>
    ...
    <div class="section1">
      ...
      <h1 class="header">Datewise Income Report <button class="Btn" id="download"> download report</button></h1>
      <div class="main1">
        <div class="main">
          <?php
          ...
          <div class="tab" id="invoice">
            <h5 class="headline1">Datewise Income Report from <?php echo $fdate ?> to <?php echo $tdate ?></h5>
            <table class="table-1">
              <thead>
                <tr>
                <tr>
              ...
              $ret = mysqli_query($conn, "SELECT IncomeDate,IncomeName,SUM(IncomeAmt) as totaldaily FROM `tblincome`  where (IncomeDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by IncomeDate");
              $cnt = 1;
